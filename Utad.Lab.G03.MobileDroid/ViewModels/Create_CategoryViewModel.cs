using Utad.Lab.G03.MobileDroid.Validators;
using Utad.Lab.G03.MobileDroid.Validators.Rules;
using Xamarin.Forms;
...
namespace Utad.Lab.G03.MobileDroid.ViewModels
{
    ...
    public class Create_CategoryViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// </summary>
        public Create_CategoryViewModel()
        {
